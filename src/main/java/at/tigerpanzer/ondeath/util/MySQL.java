...
public class MySQL {
  ...
  private String messageprefix = "[OnDeath | MySQL] ";
  ...
  public void createTable() {
    if (isConnected()) {
      try {
        connection.createStatement().executeUpdate("CREATE TABLE IF NOT EXISTS FirstDeath (id int(30) NOT NULL AUTO_INCREMENT PRIMARY KEY, PlayerName VARCHAR(100), UUID VARCHAR(100), FirstDeath " +
            "VARCHAR(10), Date VARCHAR(100))");
