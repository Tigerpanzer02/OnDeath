...
public class Utils {
  ...
  public static String setPlaceholders(final Player p, String str) {
    ...
    formatted = StringUtils.replace(formatted, "%OnDeath-player-displayname%", p.getDisplayName());
    formatted = StringUtils.replace(formatted, "%OnDeath-player-uuid%", p.getUniqueId().toString());
    formatted = StringUtils.replace(formatted, "%OnDeath-player-gamemode%", p.getGameMode().name());
    formatted = StringUtils.replace(formatted, "%OnDeath-world%", p.getWorld().getName());
    formatted = StringUtils.replace(formatted, "%OnDeath-player-health%", String.valueOf(p.getHealth()));
    formatted = StringUtils.replace(formatted, "%OnDeath-player-max-health%", String.valueOf(p.getMaxHealth()));
    formatted = StringUtils.replace(formatted, "%OnDeath-max-players%", String.valueOf(Bukkit.getServer().getMaxPlayers()));
    formatted = StringUtils.replace(formatted, "%OnDeath-online-players%", String.valueOf(Bukkit.getServer().getOnlinePlayers().size()));
